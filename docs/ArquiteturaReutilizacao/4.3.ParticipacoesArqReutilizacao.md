...
| Pedro de Oliveira Campos Barbosa        |                                                                                                |                                                                                |
| Pedro Henrique da Silva Melo            |                                                                                                |                                                                                |
| Raquel Temóteo Eucaria Pereira da Costa | Implementação do backend e banco de dados. Ajuste no diagrama de pacotes. Diagrams de dados.   | Excelente                                                                      |
...
| 16/08/2024 | 1.4    | Adiciona participação | Sabrina B.      |
