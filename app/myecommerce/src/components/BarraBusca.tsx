...
export default function Login() {
    return (
        <div className="p-10 w-screen flex items-center bg-[#121212]"> {/* barra de busca */}
            <div className="flex bg-neutral-900 w-72 p-3 rounded-full mr-5 hover:bg-neutral-700 ease-in-out duration-300">
